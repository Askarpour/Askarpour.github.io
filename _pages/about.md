...
I also shortly worked with [Prof. Di Nitto](https://dinitto.faculty.polimi.it/) on [SDOALITE European Project](https://www.sodalite.eu/).  The goal of the project is to increase the simplicity of deploying heterogeneous systems and enabling developers to describe their applications once, using high level semantic abstractions and targeting generic abstracted execution platform to bring-up a runtime bootstrap environment. 
